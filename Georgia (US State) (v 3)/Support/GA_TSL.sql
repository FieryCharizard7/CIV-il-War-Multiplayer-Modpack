...
INSERT OR REPLACE INTO Civilizations_YagemStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			151,	59,		null,	null);

CREATE TABLE IF NOT EXISTS Civilizations_YagemRequestedResource(Type, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4);
INSERT INTO Civilizations_YagemRequestedResource
		(Type,							Req1)
VALUES	('CIVILIZATION_CALCGEORGIA',	'RESOURCE_COTTON');
--------------------------------------------------------------------------------------------------------------------------
...
INSERT OR REPLACE INTO Civilizations_YahemStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			26,		51,		null,	null);
...
--INSERT OR REPLACE INTO Civilizations_CordiformStartPosition
		(Type,									X,		Y,		AltX,	AltY)
--VALUES	('CIVILIZATION_CALCGEORGIA',			8,		34,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_GreatestEarthStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			17,		42,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_AmericasGiantStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			42,		111,	null,	null);
...
INSERT OR REPLACE INTO Civilizations_AmericasStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			42,		51,	null,	null);
...
INSERT OR REPLACE INTO Civilizations_NorthAmericaGiantStartPosition
		(Type,									X,		Y,	AltX,	AltY)
VALUES	('CIVILIZATION_CALCGEORGIA',			86,		42,	null,	null);
