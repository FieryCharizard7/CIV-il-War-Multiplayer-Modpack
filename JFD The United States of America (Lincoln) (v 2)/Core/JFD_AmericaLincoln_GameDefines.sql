...
INSERT INTO Civilization_FreeBuildingClasses 
			(CivilizationType, 							BuildingClassType)
VALUES		('CIVILIZATION_JFD_AMERICA_LINCOLN', 	'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_PENNSYLVANIA', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_MICHIGAN', 				'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_OHIO', 					'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_CALC_KENTUCKY', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_WISCONSIN', 				'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_WEST_VIRGINIA', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_RHODEISLAND', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_NEW_YORK', 				'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_CALC_IOWA', 				'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_NEW_HAMPSHIRE', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_MASSACHUSETTS', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_ILLINOIS', 				'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_S_NEBRASKA', 			'BUILDINGCLASS_WORKSHOP'),
			('CIVILIZATION_CALC_CONNECTICUT', 		'BUILDINGCLASS_WORKSHOP');
--------------------------------	
