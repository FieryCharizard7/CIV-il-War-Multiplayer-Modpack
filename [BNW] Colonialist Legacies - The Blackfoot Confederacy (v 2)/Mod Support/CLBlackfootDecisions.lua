...
local Decisions_CLHonorWarriorSociety = {}
	Decisions_CLHonorWarriorSociety.Name = "TXT_KEY_DECISIONS_CLBLACKFOOT_HONORWARRIORSOCIETY_NAME"
	Decisions_CLHonorWarriorSociety.Desc = "TXT_KEY_DECISIONS_CLBLACKFOOT_HONORWARRIORSOCIETY_DESC"
	HookDecisionCivilizationIcon(Decisions_CLHonorWarriorSociety, "CIVILIZATION_CLBLACKFOOT")
	Decisions_CLHonorWarriorSociety.CanFunc = (
	function(pPlayer)
		if (pPlayer:GetCivilizationType() ~= GameInfoTypes.CIVILIZATION_CLBLACKFOOT) then return false, false end
		if load(pPlayer, "Decisions_CLHonorWarriorSociety") == true then
			Decisions_CLHonorWarriorSociety.Desc = Locale.ConvertTextKey("TXT_KEY_DECISIONS_CLBLACKFOOT_HONORWARRIORSOCIETY_ADOPTED")
			return false, false, true
		end
		
		Decisions_CLHonorWarriorSociety.Desc = Locale.ConvertTextKey("TXT_KEY_DECISIONS_CLBLACKFOOT_HONORWARRIORSOCIETY_DESC")
...
Decisions_AddCivilisationSpecific(GameInfoTypes["CIVILIZATION_CLBLACKFOOT"], "Decisions_CLHonorWarriorSociety", Decisions_CLHonorWarriorSociety)
...
function HonorExplosion(player, unit)
	...
	if load(pPlayer, "Decisions_CLHonorWarriorSociety") == true then
		...
		if pPlayer:IsHuman() then
			Events.GameplayAlertMessage(Locale.ConvertTextKey("TXT_KEY_DECISIONS_CLBLACKFOOT_HONORWARRIORSOCIETY_NOTIFICATION", pUnit:GetName(), iCulture, iGolden))
		end
	end
end
...
local Decisions_CLPreserveBuffalo = {}
	Decisions_CLPreserveBuffalo.Name = "TXT_KEY_DECISIONS_CLBLACKFOOT_PRESERVEBUFFALO_NAME"
	Decisions_CLPreserveBuffalo.Desc = "TXT_KEY_DECISIONS_CLBLACKFOOT_PRESERVEBUFFALO_DESC"
	HookDecisionCivilizationIcon(Decisions_CLPreserveBuffalo, "CIVILIZATION_CLBLACKFOOT")
	Decisions_CLPreserveBuffalo.CanFunc = (
	function(pPlayer)
		if (pPlayer:GetCivilizationType() ~= GameInfoTypes.CIVILIZATION_CLBLACKFOOT) then return false, false end
		if load(pPlayer, "Decisions_CLPreserveBuffalo") == true then
			Decisions_CLPreserveBuffalo.Desc = Locale.ConvertTextKey("TXT_KEY_DECISIONS_CLBLACKFOOT_PRESERVEBUFFALO_ADOPTED")
			return false, false, true
		end
		
		Decisions_CLPreserveBuffalo.Desc = Locale.ConvertTextKey("TXT_KEY_DECISIONS_CLBLACKFOOT_PRESERVEBUFFALO_DESC")
...
Decisions_AddCivilisationSpecific(GameInfoTypes["CIVILIZATION_CLBLACKFOOT"], "Decisions_CLPreserveBuffalo", Decisions_CLPreserveBuffalo)
