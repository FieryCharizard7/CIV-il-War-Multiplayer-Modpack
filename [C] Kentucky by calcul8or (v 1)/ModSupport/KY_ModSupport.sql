...
VALUES      ('LEADER_CALCHENRYCLAY',	'POLICY_AGGRESSIVE_X',	'POLICY_EXPANSIVE_X');

UPDATE Leaders 
SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
	THEN 'Henry Clay [ICON_WAR][ICON_FOOD]'
	ELSE 'TXT_KEY_LEADER_CALCHENRYCLAY' END) 
WHERE Type = 'LEADER_CALCHENRYCLAY';

CREATE TRIGGER CivIVTraitsCalcKentucky
AFTER INSERT ON Leaders WHEN 'LEADER_CALCHENRYCLAY' = NEW.Type
BEGIN
	UPDATE Leaders 
	SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
		THEN 'Henry Clay [ICON_WAR][ICON_FOOD]'
...
VALUES  ('CIVILIZATION_CALC_KENTUCKY',             null,                                   'JFD_Germanic'),
        ('CIVILIZATION_CALC_KENTUCKY',             null,                                   'JFD_Finno_Ugric'),
        ('CIVILIZATION_CALC_KENTUCKY',             'TXT_KEY_COLONY_NAME_KENTUCKY_01',    null),
        ('CIVILIZATION_CALC_KENTUCKY',             'TXT_KEY_COLONY_NAME_KENTUCKY_02',    null),
        ('CIVILIZATION_CALC_KENTUCKY',             'TXT_KEY_COLONY_NAME_KENTUCKY_03',    null),
        ('CIVILIZATION_CALC_KENTUCKY',             'TXT_KEY_COLONY_NAME_KENTUCKY_04',    null),
        ('CIVILIZATION_CALC_KENTUCKY',             'TXT_KEY_COLONY_NAME_KENTUCKY_05',    null);
--==========================================================================================================================    
...
VALUES  ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_SLAVERY',       5);
--==========================================================================================================================
...
SELECT  'CIVILIZATION_CALC_KENTUCKY', ArtDefineTag, DefeatScreenEarlyTag, DefeatScreenMidTag, DefeatScreenLateTag, CultureType, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_AMERICA';
 
UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Colonial'
WHERE Type = 'CIVILIZATION_CALC_KENTUCKY'
...
INSERT INTO Leader_Flavors
        (LeaderType,                FlavorType,                 Flavor)
VALUES  ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_MERCENARY',     8);
--==========================================================================================================================    
...
INSERT INTO Leader_Flavors
        (LeaderType,            FlavorType,                             Flavor)
VALUES  ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',     8);
--==========================================================================================================================    
...
SELECT  'CIVILIZATION_CALC_KENTUCKY', CurrencyType
...
SELECT  'CIVILIZATION_CALC_KENTUCKY', LegislatureName, OfficeTitle, GovernmentType,  Weight
...
SELECT	'CIVILIZATION_CALC_KENTUCKY', HeadOfGovernmentName
...
SELECT  'CIVILIZATION_CALC_KENTUCKY',		DefaultTitle,                                   UniqueTitle
...
SELECT  'CIVILIZATION_CALC_KENTUCKY',   PoliticsType,               UniqueName
...
INSERT INTO Leader_Flavors
        (LeaderType,				FlavorType,                        Flavor)
VALUES  ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_GOVERNMENT',     8),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_CULTURE',        3),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_ECONOMIC',       7),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_FOREIGN',        7),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_INDUSTRY',       8),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_MILITARY',       7),
        ('LEADER_CALCHENRYCLAY',    'FLAVOR_JFD_REFORM_RELIGION',       5);
--==========================================================================================================================    
...
SET UnitClassType = (CASE WHEN EXISTS(SELECT Type FROM UnitClasses WHERE Type = 'UNITCLASS_EE_EXPLORER' )
		THEN 'UNITCLASS_EE_EXPLORER'
	    ELSE 'UNITCLASS_MUSKETMAN' END) 
WHERE UnitType = 'UNIT_KY_FRONTIERSMAN'