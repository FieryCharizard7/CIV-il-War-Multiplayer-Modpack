...
INSERT OR REPLACE INTO Civilizations_YagemStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			61,		117,	null,	null);

CREATE TABLE IF NOT EXISTS Civilizations_YagemRequestedResource(Type, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4);
INSERT INTO Civilizations_YagemRequestedResource
		(Type,							Req1)
VALUES	('CIVILIZATION_CALC_KENTUCKY',	'RESOURCE_WHEAT');
--------------------------------------------------------------------------------------------------------------------------
...
INSERT OR REPLACE INTO Civilizations_YahemStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			27,		54,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_CordiformStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			13,		34,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_GreatestEarthStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			15,		47,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_AmericasStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			43,		54,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_NorthAmericaGiantStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			87,		54,		null,	null);
...
INSERT OR REPLACE INTO Civilizations_NorthAmericaHugeStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_KENTUCKY',			83,		39,		null,	null);
