...
SELECT	'POLICY_CT_TRAIT',	'BUILDINGCLASS_EE_WEIGH_HOUSE',	50
WHERE EXISTS (SELECT Type FROM Buildings WHERE Type = 'BUILDING_EE_WEIGH_HOUSE');

UPDATE Units
SET Moves = (CASE WHEN EXISTS(SELECT Type FROM UnitClasses WHERE Type = 'UNITCLASS_EE_EXPLORER' )
		THEN '5'
	    ELSE '4' END) 
WHERE Type = 'UNIT_CT_WHALER';

UPDATE Units
SET Moves = (CASE WHEN EXISTS(SELECT Type FROM UnitClasses WHERE Type = 'UNITCLASS_EE_EXPLORER' )
		THEN '5'
	    ELSE '4' END) 
WHERE Type = 'UNIT_CT_WHALER_NOBUILD';
UPDATE Units
...
VALUES      ('LEADER_CALCTRUMBULL',		'POLICY_MERCANTILE_X',	'POLICY_SEAFARING_X');

UPDATE Leaders 
SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
	THEN 'Jonathan Trumbull [ICON_GOLD] [ICON_GREAT_EXPLORER]'
	ELSE 'TXT_KEY_LEADER_CALCTRUMBULL' END) 
WHERE Type = 'LEADER_CALCTRUMBULL';

CREATE TRIGGER CivIVTraitsTrumbull
AFTER INSERT ON Leaders WHEN 'LEADER_CALCTRUMBULL' = NEW.Type
BEGIN
	UPDATE Leaders 
	SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
		THEN 'Jonathan Trumbull [ICON_GOLD] [ICON_GREAT_EXPLORER]'
...
VALUES  ('CIVILIZATION_CALC_CONNECTICUT',       null,									    'JFD_Latinate'),
        ('CIVILIZATION_CALC_CONNECTICUT',       null,									    'JFD_Latinate'),
        ('CIVILIZATION_CALC_CONNECTICUT',       'TXT_KEY_COLONY_NAME_CALC_CONNECTICUT_01',   null),
        ('CIVILIZATION_CALC_CONNECTICUT',       'TXT_KEY_COLONY_NAME_CALC_CONNECTICUT_02',   null),
        ('CIVILIZATION_CALC_CONNECTICUT',       'TXT_KEY_COLONY_NAME_CALC_CONNECTICUT_03',   null),
        ('CIVILIZATION_CALC_CONNECTICUT',       'TXT_KEY_COLONY_NAME_CALC_CONNECTICUT_04',   null),
        ('CIVILIZATION_CALC_CONNECTICUT',       'TXT_KEY_COLONY_NAME_CALC_CONNECTICUT_05',   null);
------------------------------------------------------------
-- Flavors
------------------------------------------------------------    
...
VALUES  ('LEADER_CALCTRUMBULL',  'FLAVOR_JFD_SLAVERY',       3);
...
SELECT  'TRAIT_CT_YANKEE',   'UNITCOMBAT_NAVALMELEE',		'PROMOTION_JFD_SCUVRY_IMMUNITY'
WHERE EXISTS (SELECT Type FROM UnitPromotions WHERE Type = 'PROMOTION_JFD_SCUVRY_IMMUNITY');

INSERT INTO Trait_FreePromotionUnitCombats
        (TraitType,			UnitCombatType,					PromotionType)
SELECT  'TRAIT_CT_YANKEE',   'UNITCOMBAT_NAVALRANGED',		'PROMOTION_JFD_SCUVRY_IMMUNITY'
WHERE EXISTS (SELECT Type FROM UnitPromotions WHERE Type = 'PROMOTION_JFD_SCUVRY_IMMUNITY');
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT',  ArtDefineTag, DefeatScreenEarlyTag, DefeatScreenMidTag, DefeatScreenLateTag, CultureType, IdealsTag, 'JFD_Colonial',  SoundtrackTag, 'AS2D_SOUND_JFD_AMERICAN'
FROM Civilization_JFD_CultureTypes WHERE CivilizationType = 'CIVILIZATION_AMERICA';
 
UPDATE Civilizations 
SET SoundtrackTag = 'JFD_Colonial'
WHERE Type = 'CIVILIZATION_CALC_CONNECTICUT'
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT', CurrencyType
...
INSERT INTO Leader_Flavors
            (LeaderType,            FlavorType,                             Flavor)
VALUES      ('LEADER_CALCTRUMBULL',  'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',     3);
--==========================================================================================================================    
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT',   LegislatureName,  OfficeTitle,  GovernmentType,  Weight
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT', HeadOfGovernmentName
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT',   DefaultTitle,  UniqueTitle
...
SELECT  'CIVILIZATION_CALC_CONNECTICUT', PoliticsType,               UniqueName
...
INSERT INTO Leader_Flavors
        (LeaderType,				FlavorType,                        Flavor)
VALUES  ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_GOVERNMENT',     3),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_CULTURE',        3),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_ECONOMIC',       7),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_FOREIGN',        3),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_INDUSTRY',       2),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_MILITARY',       7),
        ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_REFORM_RELIGION',       5);
--==========================================================================================================================  
--==========================================================================================================================    
...
INSERT INTO Leader_Flavors
        (LeaderType,               FlavorType,               Flavor)
VALUES  ('LEADER_CALCTRUMBULL',    'FLAVOR_JFD_MERCENARY',     8);
...
INSERT INTO Civilizations_YagemStartPosition
			(Type,								X,		Y)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	158,	66);
------------------------------------------------------------
...
INSERT INTO Civilizations_YahemStartPosition
			(Type,								X,		Y)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	32,		57);
------------------------------------------------------------
...
INSERT INTO Civilizations_GreatestEarthStartPosition
			(Type,								X,		Y)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	21,		51);
------------------------------------------------------------
...
INSERT INTO Civilizations_AmericasStartPosition
			(Type,								X,		Y)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	48,		57);
------------------------------------------------------------
...
INSERT INTO Civilizations_AmericasGiantStartPosition
			(Type,								X,		Y)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	72,		121);
--------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO Civilizations_NorthAmericaGiantStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_CONNECTICUT',		101,	57,		null,	null);
--------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO Civilizations_NorthAmericaHugeStartPosition
		(Type,									X,		Y,		AltX,	AltY)
VALUES	('CIVILIZATION_CALC_CONNECTICUT',		97,		45,		null,	null);
...
INSERT INTO Civilizations_YagemRequestedResource
			(Type, 								Req1,				Req2)
VALUES		('CIVILIZATION_CALC_CONNECTICUT',	'RESOURCE_PEARLS',	'RESOURCE_COW');
------------------------------------------------------------	
