...
VALUES      ('LEADER_CALC_PIERPONT',		'POLICY_AGGRESSIVE_X',		'POLICY_PROTECTIVE_X');

UPDATE Leaders 
SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
	THEN 'Pierpont [ICON_WAR][ICON_STRENGTH]'
	ELSE 'TXT_KEY_LEADER_CALC_PIERPONT' END) 
WHERE Type = 'LEADER_CALC_PIERPONT';

CREATE TRIGGER CivIVTraitsCalcPierpont
AFTER INSERT ON Leaders WHEN 'LEADER_CALC_PIERPONT' = NEW.Type
BEGIN
	UPDATE Leaders 
	SET Description = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X' )
		THEN 'Pierpont [ICON_WAR][ICON_STRENGTH]'
...
VALUES  ('CIVILIZATION_WEST_VIRGINIA',             null,                                   'JFD_Germanic'),
        ('CIVILIZATION_WEST_VIRGINIA',             null,                                   'JFD_Finno_Ugric'),
        ('CIVILIZATION_WEST_VIRGINIA',             'TXT_KEY_COLONY_NAME_WEST_VIRGINIA_01',  null),
        ('CIVILIZATION_WEST_VIRGINIA',             'TXT_KEY_COLONY_NAME_WEST_VIRGINIA_02',  null),
        ('CIVILIZATION_WEST_VIRGINIA',             'TXT_KEY_COLONY_NAME_WEST_VIRGINIA_03',  null),
        ('CIVILIZATION_WEST_VIRGINIA',             'TXT_KEY_COLONY_NAME_WEST_VIRGINIA_04',  null),
        ('CIVILIZATION_WEST_VIRGINIA',             'TXT_KEY_COLONY_NAME_WEST_VIRGINIA_05',  null);
--==========================================================================================================================
...
SELECT  'CIVILIZATION_WEST_VIRGINIA', CurrencyType
...
SELECT	'CIVILIZATION_WEST_VIRGINIA',	ArtDefineTag, CultureType, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
...
WHERE Type = 'CIVILIZATION_WEST_VIRGINIA'
...
VALUES  ('LEADER_CALC_PIERPONT',    'FLAVOR_JFD_MERCENARY',     7);
--==========================================================================================================================    
...
INSERT INTO Leader_Flavors
            (LeaderType,         FlavorType,                             Flavor)
VALUES      ('LEADER_CALC_PIERPONT',    'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',     8);