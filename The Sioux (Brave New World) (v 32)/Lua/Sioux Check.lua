					...
					if pUnit:GetUnitType() == uSioux then
						if bandAward >= 1 then
							...
							elseif bRandom == 13 then
								pUnit:SetName("Bad Face");
							elseif bRandom == 14 then
								pUnit:SetName("Blue Horse");
							elseif bRandom == 15 then
								pUnit:SetName("Old Smoke");
							elseif bRandom == 16 then
								pUnit:SetName("Afraid of His Horse");
							elseif bRandom == 17 then
								pUnit:SetName("Stone Knife");
							elseif bRandom == 18 then
								pUnit:SetName("Slow Buffalo");
							elseif bRandom == 19 then
								pUnit:SetName("Lone Man");
							elseif bRandom == 20 then
								pUnit:SetName("Little Wound");
							end
